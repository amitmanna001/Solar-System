...
#include "SaturnOrbit.h"


// Sets default values
ASaturnOrbit::ASaturnOrbit()
{
...
// Called every frame
void ASaturnOrbit::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void ASaturnOrbit::GenerateHollowEllipseMesh()
{
